    ...
    <div className="hidden-fee-bg relative">
      ...
      <div className="custom-container py-28 relative z-10">
        ...
        {items.map((item, index) => (
          <div key={item.id} className="mb-3 border-[#5D7379] border-2 rounded-lg" data-aos="fade-zoom-in" data-aos-duration={item.delay}>
            <div onClick={() => handleClick(index)} className="bg-[#253236] p-5  text-lg font-bold text-white flex justify-between items-center">
            ...
            {activeIndex === index && (
              <div style={{ fontFamily: "Satoshi,sans-serif" }} className="bg-[#253236] px-5 pb-5">
                {item.description}
                {/* {item?.description2 && (
                  <div className="mt-1">
                    <br />
